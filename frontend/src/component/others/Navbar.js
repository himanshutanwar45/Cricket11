...
const Navbar = () => {
  ...
  let Full_Name = localStorage ? localStorage.getItem("Full_Name") : null;
          ...
          <div className="collapse navbar-collapse" id="navbarSupportedContent">
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li className="nav-item dropdown">
                ...
                <ul className="dropdown-menu">
                  <li><Link className="dropdown-item" to="/get_teamList">Get Team</Link></li>
                </ul>
              </li>
              ...
              <li className="nav-item dropdown">
                ...
                <ul className="dropdown-menu">
                  <li><Link className="dropdown-item" to="/get_recentMatch">Recent Match List</Link></li>
                  <li><Link className="dropdown-item" to="/">Schedule Match List</Link></li>
                </ul>
              </li>
              ...
              <li className="nav-item dropdown">
                ...
                <ul className="dropdown-menu">
                  <li><Link className="dropdown-item" to="/">Preview Team</Link></li>
                </ul>
              </li>
            ...
            {!localStorage.getItem('auth-Token') ? <form className="d-flex" role="search">
              ...
              <ul className="navbar-nav mb-2 mb-lg-0" style={{marginRight:"100px"}}>
                <li className="nav-item">
                  <p className="my-2"><strong>{Full_Name}</strong></p>
                </li>
